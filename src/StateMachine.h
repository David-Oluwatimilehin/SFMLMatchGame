...
private:
	...
	EDifficultyLevel m_difficultyLevel;
...
public:
	...
	void SetDifficulty(EDifficultyLevel difficultylevel) { m_difficultyLevel = difficultylevel; }
	EDifficultyLevel GetDifficulty() const { return m_difficultyLevel; }
